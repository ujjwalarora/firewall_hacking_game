...
<p>
Let the hacker in you surface as you're faced with innumerable
problems that require you to procure classified information from varied sources.
Pit your brains against competitors from across the country to
find out if you can measure up to the challenge!
Do you have the skills to penetrate the Firewall?
Hack, slash, burn.. Don't let your guard down..
Don't let the firewall get to you before you get to it.</p>
<marquee dir="rtl" ><img src="./img/Hacker_Detected.jpg" width="160" height="110" /></marquee>
<br />
...
<li><a href="register.php" class="theory tip"><span class="tt">REGISTER</span></a></li>
<li><a href="login-main.php" class="charm tip"><span class="tt">LOGIN</span></a></li>
